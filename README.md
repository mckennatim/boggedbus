...
<blockquote style="color:blue;text-align:center;margin-left:40px;margin-right:40px;" cite="http://hubhacks2.challengepost.com/">HubHacks 2 is a data visualization challenge managed by the City of Boston. We're asking developers, designers, and data scientists to find new insights in urban data and show them in inviting, understandable, and thought-provoking ways. </blockquote>
